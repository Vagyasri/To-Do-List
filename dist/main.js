...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"createList\": () => (/* binding */ createList),\n/* harmony export */   \"deleteList\": () => (/* binding */ deleteList),\n/* harmony export */   \"deleteAllDone\": () => (/* binding */ deleteAllDone)\n/* harmony export */ });\n/* harmony import */ var _status_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./status.js */ \"./src/status.js\");\n\n\nconst createList = (task) => (\n  {\n    index: _status_js__WEBPACK_IMPORTED_MODULE_0__.todoList.length,\n    description: task,\n    completed: false,\n  });\n\nconst deleteList = (e) => {\n  const deleteButton = e.target;\n  if (deleteButton.classList[1] === 'fa-trash-alt') {\n    const indexToDelete = Number(deleteButton.getAttribute('data-index'));\n    (0,_status_js__WEBPACK_IMPORTED_MODULE_0__.removeLocal)(indexToDelete);\n  }\n};\n\nconst deleteAllDone = () => {\n  const completed = document.querySelectorAll('.check');\n  completed.forEach((checkbox) => {\n    if (checkbox.checked) {\n      checkbox.parentElement.parentElement.remove();\n    }\n  });\n  for (let i = 0; i < _status_js__WEBPACK_IMPORTED_MODULE_0__.todoList.length; i += 1) {\n    // eslint-disable-next-line array-callback-return\n    _status_js__WEBPACK_IMPORTED_MODULE_0__.todoList.filter((task) => {\n      if (task.completed) {\n        const index = _status_js__WEBPACK_IMPORTED_MODULE_0__.todoList.indexOf(task);\n        _status_js__WEBPACK_IMPORTED_MODULE_0__.todoList.splice(index, 1);\n        let i = 0;\n        while (i < _status_js__WEBPACK_IMPORTED_MODULE_0__.todoList.length) {\n          if (_status_js__WEBPACK_IMPORTED_MODULE_0__.todoList[i].id > task.id) {\n            _status_js__WEBPACK_IMPORTED_MODULE_0__.todoList[i].id -= 1;\n          }\n          i += 1;\n        }\n        (0,_status_js__WEBPACK_IMPORTED_MODULE_0__.save)();\n      }\n    });\n  }\n};\n\n//# sourceURL=webpack://webpack-demo/./src/crud.js?");
